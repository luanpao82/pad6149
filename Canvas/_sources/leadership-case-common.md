...
Select **3–5 news articles** published in the past two years (2024–2026) directly related to the issue you analyze.

- **Source quality:** published journalism — newspapers, news sites, or sector media (Nonprofit Quarterly, SSIR, Chronicle of Philanthropy). No blogs or un-edited opinion.
...
1. **What is happening?** Read across the articles for patterns — recurring themes, who is most affected, what is getting worse or better. Add quantitative context with **Census Reporter** (censusreporter.org).
2. **Why is this happening?** Root-cause analysis. Integrate frameworks from your MNM coursework (financial management, strategy, HR, governance). Use **Google Scholar** for academic grounding.
3. **Who is responding?** Identify at least two organizations (nonprofits, funders, agencies) addressing the challenge — their strategies, successes, and gaps. Research them on **Candid/GuideStar** (candid.org).
4. **What's missing?** The most important question: what gap remains that an organization could exist to fill? Identify what the media and existing organizations are *not* seeing.
5. **How would you lead through this?** As a nonprofit leader, describe the concrete, operational strategy you would pursue. Not aspirational — what would you actually do?

Cite all articles and sources in **APA 7th edition** (in-text + reference list; references do not count toward the word limit).
