...
- PAD 5145 – Volunteerism in Nonprofit Management (Volunteer Case Study + Volunteer Motivation Literature Review)
...
## The Process: From Prior Coursework to Your Organization
...
> [!tip] Using NotebookLM for This Assignment
> Upload your PAD 6417 and PAD 5145 assignments to a NotebookLM notebook. You can upload multiple sources — NotebookLM will synthesize across them.
>
> Sample prompts:
> ```
...
Add a "Team" page and a "Get Involved" page (see Website Update section below).

---

## What Do I Submit?

A **5–7 page, double-spaced** HR & Volunteer Management Plan covering:
...
- Recruitment strategy (where and how will you find volunteers?)
...
- **Format:** Word (.docx)
- **File name:** `[YourLastName]_HRVolunteerPlan.docx`
- **Submit to:** Webcourses@UCF → Assignments → Week 5: HR & Volunteer Management Plan

---

## Video Demo: Building an Org Chart with Canva AI

<!--
RECORDING SCRIPT — Week 5 Video (approximately 2 minutes)
